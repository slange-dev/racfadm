/*%NOCOMMENT====================* REXX *==============================*/
/*PURPOSE:  RACFADM - Generate Profile Source for all LOGDEFLT        */
/*                    Resource Classes, Option GA                     */
/*--------------------------------------------------------------------*/
/* FLG  YYMMDD  USERID   DESCRIPTION                                  */
/* ---  ------  -------  -------------------------------------------- */
/* @A1  260205  Janko    Skip classes per RDEFINE documentation       */
/* @A0  260205  Janko    IRRXUTIL version                             */
/*====================================================================*/
...
/* Generate profile source for all logdeflt resource classes */
do t = 2 to CLS.BASE.LOGDEFLT.0     /* Skip DATASET */
  filter = "**"
  class = cls.base.LOGDEFLT.t
